        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WriterType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "WriterApplicationRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WriterApplicationRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WriterApplicationRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeedItems_AspNetUsers_WriterId",
                        column: x => x.WriterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FeedItems_FeedSources_SourceId",
                        column: x => x.SourceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedItems_WriterId",
                table: "FeedItems",
                column: "WriterId");

            migrationBuilder.CreateIndex(
                name: "IX_WriterApplicationRequests_UserId",
                table: "WriterApplicationRequests",
                column: "UserId");
        }
